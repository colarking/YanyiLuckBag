...
//            bitmapShader = new BitmapShader(bitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
            ...
            int canvasSize = bitmap.getWidth() > bitmap.getHeight() ? bitmap.getHeight() : bitmap.getWidth();
            mBitmapRect = new RectF(margin, margin, canvasSize - margin, canvasSize - margin);
            bitmapShader = new BitmapShader(ThumbnailUtils.extractThumbnail(bitmap, canvasSize, canvasSize),
