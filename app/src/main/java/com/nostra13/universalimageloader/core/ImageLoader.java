...
public class ImageLoader {
    ...
    public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options,
        ...
        checkConfiguration();
        if (!uri.startsWith(AmayaConstants.PREFIX_HTTP) && !uri.startsWith(AmayaConstants.PREFIX_FILE) && !uri.startsWith(AmayaConstants.PREFIX_DRAWABLE)) {
            AmayaLog.e(TAG, "displayImage()...uri=" + uri + "--listener=" + listener);
        }
        if (imageAware == null) {
